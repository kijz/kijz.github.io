import { Container, Box, Heading, Image, Button, useColorModeValue, Link } from '@chakra-ui/react'
    ...
    <Container>
      ...
      <Box display={{ md: 'flex' }}>
        ...
        <Box flexShrink={0} mt={{ base: 4, md: 0 }} ml={{ md: 6 }} align="center">
          <Image borderColor="whiteAlpha.800" borderWidth={4} borderStyle="solid" maxWidth="100px" display="inline-block" borderRadius="full" src="/images/profile.jpeg" alt="Profile Image" />
        </Box>
      </Box>
      ...
      <Section delay={0.2}>
        ...
        <BioSection>
          ...
          Completed the Master's Program of Information Science at RWTH-Aachen University.
        </BioSection>
        <BioSection>
